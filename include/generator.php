    <section class="section" id="create_qr">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="section-title">
                        <h2><?= $_CONFIG['generator_title']; ?></h2>
                        <p><?= $_CONFIG['generator_description']; ?></p>
                    </div>
                </div>
            </div>
            <div class="row mt-3">
                                ...
                                <div class="form-group">
                                    <ul class="nav nav-pills nav-fill" role="tablist">
                                        ...
                                        if ($_CONFIG['viber'] == true) { ?>
                                            <li class="nav-item">
                                                <a class="nav-link<?php if ($getsection == "#viber") echo " active"; ?>" href="#viber" role="tab" data-toggle="tab"><i class="fa fa-viber"></i> <span class="d-none d-sm-inline-block">Viber</span></a>
                                            </li>
                                        <?php
                                        }
                                        ...
                                        if ($_CONFIG['vcard'] == true) { ?>
                                            <li class="nav-item">
                                                <a class="nav-link<?php if ($getsection == "#vcard") echo " active"; ?>" href="#vcard" role="tab" data-toggle="tab"><i class="fa fa-list-alt"></i> <span class="d-none d-sm-inline-block">V-card</span></a>
                                            </li>
                                        <?php
                                        }
                                        ...
                                        <div class="row">
                                            <div class="col-6">
                                                ...
                                                <div class="input-group qrcolorpicker mb-2">
                                                    ...
                                                    <input type="text" class="form-control" data-format="hex" value="<?php echo $stringfrontcolor; ?>" name="frontcolor">
                                                </div>
