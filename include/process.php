...
case '#viber':
    $countrycode = filter_input(INPUT_POST, "viber_countrycode", FILTER_SANITIZE_STRING);

    $number = filter_input(INPUT_POST, "viber_number", FILTER_SANITIZE_STRING);

    if ($number) {
        $output_data = 'viber://chat?number=%2B'.$countrycode.$number;
    }
